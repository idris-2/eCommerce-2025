...
/*
let UserService = {
  login: function (entity, callback, error_callback) {
    $.ajax({
      url: Constants.PROJECT_BASE_URL + "auth/login",
      type: "POST",
      data: JSON.stringify(entity),
  ...
  getUserInfo: function (callback, error_callback) {
    RestClient.get("auth/user", callback, error_callback);
  },
};
*/